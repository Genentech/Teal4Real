...
>The result should be a demo app like [this one](# "URL will be added soon")
...
In order to use Teal4Real with your own dataset, you'd have to provide a function that 
returns your dataset, plus a number of configurations that tell the app e.g. which variables are time-to-event 
endpoints, etc.
